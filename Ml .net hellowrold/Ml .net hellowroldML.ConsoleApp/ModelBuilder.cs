...
namespace Ml__net_hellowroldML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Virion\Desktop\ML .net\ML-.net\Ml .net hellowrold\Ml .net hellowrold\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\Virion\AppData\Local\Temp\MLVSTools\Ml .net hellowroldML\Ml .net hellowroldML.Model\MLModel.zip";
